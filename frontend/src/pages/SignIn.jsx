  ...
  return (
    <PageWrapper>
      <div className="mx-auto max-w-md px-8 pt-24 pb-20">
        <motion.h1 className="text-3xl font-bold mb-6">Sign In</motion.h1>
        <form onSubmit={onSubmit} className="rounded-3xl bg-white/5 border border-white/10 p-6 space-y-4">
          {error && (
